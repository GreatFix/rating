  ...
  const modal = (
    <ModalRoot activeModal={activeModal} onClose={closeModal} className={'Overflow'}>
      ...
      >
        ...
        <MiniInfoCell before={<Icon20User />} textWrap="full" textLevel="primary">
        ...
        <MiniInfoCell before={<Icon20HomeOutline />} textWrap="full" textLevel="primary">
          Москва
        </MiniInfoCell>
        ...
        <MiniInfoCell before={<Icon20MentionOutline />}>@durov</MiniInfoCell>
      ...
      <Panel id={id} className={'Overflow'}>
        ...
        <Group>
          ...
          >
            ...
            <MiniInfoCell before={<Icon20Info />} mode="more" onClick={handleExtendedInfoClick}>
            ...
            <RichCell
              ...
              before={
                <Avatar
                  size={48}
                  src={
                    'https://sun2-9.userapi.com/s/v1/ig2/JGiYTleVNv9LtJoYGm0ihr-xvBLpnxxeX0kEs-PKBsoN_17PQ_IClctkZhJckIgz7aTPBnLQ9xrhw2A-r3fxc17M.jpg?size=50x0&quality=96&crop=65,265,551,551&ava=1'
                  }
                />
              }
